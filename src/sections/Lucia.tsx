...
const Lucia = () => {
  useGSAP(() => {
    gsap.set('.lucia-life', { marginTop: '-60vh' });
    ...
    <section className="lucia-life">
      ...
      <div className="lg:w-1/2 lucia-life-content">
        <div className="max-w-xl lg:ps-32 ps-10">
          ...
          <p>
            Life has been coming at her swinging ever since. Fighting for her family landed her in
            the Leonida Penitentiary. Sheer luck got her out. Lucia’s learned her lesson — only
            smart moves from here.
          </p>
        </div>
